...
import Frontend.Assesor_Window_S
...
class Assesor:
    ...
    def click_submit(self):
        ...
        try:
            ...
            obj_assesor_database = Model_class.assesor_registration.AssesorsRegistration(
                self.e_n_ced_as.get(),
                self.e_nombres_as.get(),
                self.e_apellidos_as.get(),
                self.e_direccion_as.get(),
                self.e_correo_as.get(),
                self.e_n_celular_as.get()
                )
            query = 'insert into asesores (id_asesor, nombres, apellidos, direccion, correo, celular) ' \
                    'values (%s, %s, %s, %s, %s, %s);'
            values = (obj_assesor_database.get_cedula_as(), obj_assesor_database.get_nombres_as(),
                      obj_assesor_database.get_apellidos_as(), obj_assesor_database.get_direccion_as(),
                      obj_assesor_database.get_correo_as(), obj_assesor_database.get_celular_as()
                      )
    ...
    def update_as(self):
        ...
        query = f"""UPDATE asesores SET id_asesor="{self.e_n_ced_as.get()}", 
                    nombres="{self.e_nombres_as.get()}", apellidos="{self.e_apellidos_as.get()}", 
                    direccion="{self.e_direccion_as.get()}", correo="{self.e_correo_as.get()}",\
                    celular="{self.e_n_celular_as.get()}" WHERE id_asesor={self.e_n_ced_as.get()}"""
    ...
    def delete_as(self):
        try:
            ...
            if ask is True:
                query = "delete from asesores where nombres=%s;"
