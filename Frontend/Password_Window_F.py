...
class Password_F:
    ...
    def __init__(self, root):
        ...
        # =============================================================
        # self.bg = PhotoImage(file='recursos/FONDO_MASTER.png')
        # Label(self.root, image=self.bg).grid(row=1, column=0, sticky='NW', padx=0, pady=0)

        # =============================================================
        # FONDO PANTALLA PRINCIPAL
        # =============================================================
        # self.imgbtn = PhotoImage(file='recursos/b_salir.png')
        # Button(self.root, image=self.imgbtn, command=self.salir_principal).place(x=1000, y=710)
        # =============================================================
        ...
        self.Column2.add_command(label='Cambiar Contraseña')
        ...
        # CREACIÓN DEL DE MENÚ AYUDA
        # =============================================================
        self.menus.add_cascade(label='AYUDA', menu=self.Column3)
        self.Column3.add_command(label='Tutorial')
        ...
        self.Column4.add_command(label='Sobre IFAP®', command=self.caja_info_ifap)
        self.Column4.add_separator()
        self.Column4.add_command(label='Sobre SIST_CONTROL (IFAP®)', command=self.caja_info_sist)
        self.Column4.add_separator()
        self.root.config(menu=self.menus)

        self.footer = Label(self.root, text='DESING® | Derechos Reservados 2021', width=150, bg='black', fg='white')
        self.footer.place(x=0, y=725)
    ...
    def principal_btn(self):
        ...
        from Facturacion.Principal_Window_F import Principal_F
        st_root = Tk()
        Principal_F(st_root)
        st_root.mainloop()
    ...
    def facturation_btn(self):
        ...
        from Facturacion.Facturation_Window_F import Facturation_F
        st_root = Tk()
        Facturation_F(st_root)
        st_root.mainloop()
